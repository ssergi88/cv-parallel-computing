"""
Simulacro completo B — MPI: round-trip Scatterv -> *10 -> Gatherv

Reparto desigual de N=14 elementos. Cada proceso multiplica por 10 su trozo.
Se recogen los resultados en las mismas posiciones con Gatherv.

Ejecutar: mpiexec -n 4 python simulacro_completo_B_mpi.py
"""
